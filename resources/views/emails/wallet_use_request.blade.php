                                    ...
                                    <td class="sm-px-24"
                                        ...
                                        <p class="sm-leading-32"
                                           style="font-weight: 600; font-size: 20px; margin: 0 0 24px; --text-opacity: 1; color: #263238; color: rgba(38, 50, 56, var(--text-opacity));">
                                            El método de liquidación es con monedero virtual del proveedor
                                        </p>
                                        ...
                                        <p style="margin: 24px 0; text-align: center">
                                            Para confirmar la liquidación, proporcione al vendedor la siguiente
                                            contraseña de único uso:

                                            <strong style="color:#7367f0;font-size: 25px;">
                                                {{$settlement->auth_token}}
                                            </strong>
                                        </p>
