                                ...
                                <tr>
                                    <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; background-color: rgba(255, 255, 255, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262; color: rgba(98, 98, 98, var(--text-opacity));" bgcolor="rgba(255, 255, 255, var(--bg-opacity))" align="left">
                                        ...
                                        <p style="margin: 24px 0;">
                                            ...
                                            <br>
                                            ¡Listo!, Tu reservación ya está completa y confirmada. Espera tu itinerario, imprime y preséntalo junto con una identificación con foto al registrarte para utilizar los servicios reservados.
                                            <br>
                                            Para que siempre llegues a tiempo <br>
                                            ...
                                            ¡Buen viaje!
                                            <br>
                                            Para solicitar tu factura envía tu información a facturacion@tripnow.mx <br>
                                            El equipo de reservaciones de Tripnow.mx <br>

                                            servicioalcliente@tripnow.mx <br>

                                            Teléfono  800 953 09 83 <br>
                                            WhatsApp Web Departamento de Reservaciones 998 830 61 91 <br>
                                        ...
                                        <p style="margin: 0 0 16px;">
                                            Tripnow.Mx agencia de viajes declara,  que los cargos realizados en tarjetas de débito o crédito procesadas por alguna de nuestras terminales de cobro pueden aparecer en sus estados de cuenta bajo los siguientes títulos “ESPIRAL AGENCIA DE VIA” (ESPIRAL AGENCIA DE VIAJES TRIPNOW.MX), “ESPIRAL GRUPO CON” (ESPIRAL GRUPO CONSOLIDADOR DE RESERVACIONES), “PRICE RES” (PRICE RES. SAPI. DE C.V.) , “CLUB TURAVIA “ (CLUB TURAVIA  S.A DE C.V), AVISO DE PRIVACIDAD.
                                            <br>
                                            Todos los datos son recabados por Agencia de viajes Tripnow.Mx con nombre fiscal GRUPO CONSOLIDADOR DE RESERVACIONES S. DE R.L de C.V. con domicilio en Av. Chichen Itza Mza 70 Lote 27 SM 58  Cancún, Quintana Roo C.P 77515. Quien declara que el departamento de servicio al cliente ubicado en el mismo domicilio es el responsable de la protección de los datos de nuestros usuarios y puede ser contactado en el 800 953 09 83.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
